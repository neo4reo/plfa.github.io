...
<pre class="Agda">{% raw %}<a id="10790" class="Keyword">data</a> <a id="Total"></a><a id="10795" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Relations.md %}{% raw %}#10795" class="Datatype">Total</a> <a id="10801" class="Symbol">(</a><a id="10802" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Relations.md %}{% raw %}#10802" class="Bound">m</a> <a id="10804" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Relations.md %}{% raw %}#10804" class="Bound">n</a> <a id="10806" class="Symbol">:</a> <a id="10808" href="https://agda.github.io/agda-stdlib/Agda.Builtin.Nat.html#97" class="Datatype">ℕ</a><a id="10809" class="Symbol">)</a> <a id="10811" class="Symbol">:</a> <a id="10813" class="PrimitiveType">Set</a> <a id="10817" class="Keyword">where</a>
  ...
  <a id="Total.forward"></a><a id="10826" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Relations.md %}{% raw %}#10826" class="InductiveConstructor">forward</a> <a id="10834" class="Symbol">:</a>
...
<a id="17431" class="Keyword">data</a> <a id="_&lt;_"></a><a id="17436" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Relations.md %}{% raw %}#17436" class="Datatype Operator">_&lt;_</a> <a id="17440" class="Symbol">:</a> <a id="17442" href="https://agda.github.io/agda-stdlib/Agda.Builtin.Nat.html#97" class="Datatype">ℕ</a> <a id="17444" class="Symbol">→</a> <a id="17446" href="https://agda.github.io/agda-stdlib/Agda.Builtin.Nat.html#97" class="Datatype">ℕ</a> <a id="17448" class="Symbol">→</a> <a id="17450" class="PrimitiveType">Set</a> <a id="17454" class="Keyword">where</a>
  ...
  <a id="_&lt;_.s&lt;s"></a><a id="17520" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Relations.md %}{% raw %}#17520" class="InductiveConstructor">s&lt;s</a> <a id="17524" class="Symbol">:</a> <a id="17526" class="Symbol">∀</a> <a id="17528" class="Symbol">{</a><a id="17529" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Relations.md %}{% raw %}#17529" class="Bound">m</a> <a id="17531" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Relations.md %}{% raw %}#17531" class="Bound">n</a> <a id="17533" class="Symbol">:</a> <a id="17535" href="https://agda.github.io/agda-stdlib/Agda.Builtin.Nat.html#97" class="Datatype">ℕ</a><a id="17536" class="Symbol">}</a>
    <a id="17542" class="Symbol">→</a> <a id="17544" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Relations.md %}{% raw %}#17529" class="Bound">m</a> <a id="17546" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Relations.md %}{% raw %}#17436" class="Datatype Operator">&lt;</a> <a id="17548" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Relations.md %}{% raw %}#17531" class="Bound">n</a>
      <a id="17556" class="Comment">-------------</a>
    <a id="17574" class="Symbol">→</a> <a id="17576" href="https://agda.github.io/agda-stdlib/Agda.Builtin.Nat.html#128" class="InductiveConstructor">suc</a> <a id="17580" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Relations.md %}{% raw %}#17529" class="Bound">m</a> <a id="17582" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Relations.md %}{% raw %}#17436" class="Datatype Operator">&lt;</a> <a id="17584" href="https://agda.github.io/agda-stdlib/Agda.Builtin.Nat.html#128" class="InductiveConstructor">suc</a> <a id="17588" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Relations.md %}{% raw %}#17531" class="Bound">n</a>{% endraw %}</pre>
...
<pre class="Agda">{% raw %}<a id="19929" class="Keyword">data</a> <a id="even"></a><a id="19934" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Relations.md %}{% raw %}#19934" class="Datatype">even</a> <a id="19939" class="Symbol">:</a> <a id="19941" href="https://agda.github.io/agda-stdlib/Agda.Builtin.Nat.html#97" class="Datatype">ℕ</a> <a id="19943" class="Symbol">→</a> <a id="19945" class="PrimitiveType">Set</a>
<a id="19949" class="Keyword">data</a> <a id="odd"></a><a id="19954" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Relations.md %}{% raw %}#19954" class="Datatype">odd</a>  <a id="19959" class="Symbol">:</a> <a id="19961" href="https://agda.github.io/agda-stdlib/Agda.Builtin.Nat.html#97" class="Datatype">ℕ</a> <a id="19963" class="Symbol">→</a> <a id="19965" class="PrimitiveType">Set</a>

<a id="19970" class="Keyword">data</a> <a id="19975" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Relations.md %}{% raw %}#19934" class="Datatype">even</a> <a id="19980" class="Keyword">where</a>

  <a id="even.zero"></a><a id="19989" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Relations.md %}{% raw %}#19989" class="InductiveConstructor">zero</a> <a id="19994" class="Symbol">:</a>
      <a id="20002" class="Comment">---------</a>
      <a id="20018" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Relations.md %}{% raw %}#19934" class="Datatype">even</a> <a id="20023" href="https://agda.github.io/agda-stdlib/Agda.Builtin.Nat.html#115" class="InductiveConstructor">zero</a>

  <a id="even.suc"></a><a id="20031" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Relations.md %}{% raw %}#20031" class="InductiveConstructor">suc</a>  <a id="20036" class="Symbol">:</a> <a id="20038" class="Symbol">∀</a> <a id="20040" class="Symbol">{</a><a id="20041" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Relations.md %}{% raw %}#20041" class="Bound">n</a> <a id="20043" class="Symbol">:</a> <a id="20045" href="https://agda.github.io/agda-stdlib/Agda.Builtin.Nat.html#97" class="Datatype">ℕ</a><a id="20046" class="Symbol">}</a>
    <a id="20052" class="Symbol">→</a> <a id="20054" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Relations.md %}{% raw %}#19954" class="Datatype">odd</a> <a id="20058" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Relations.md %}{% raw %}#20041" class="Bound">n</a>
      <a id="20066" class="Comment">------------</a>
    <a id="20083" class="Symbol">→</a> <a id="20085" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Relations.md %}{% raw %}#19934" class="Datatype">even</a> <a id="20090" class="Symbol">(</a><a id="20091" href="https://agda.github.io/agda-stdlib/Agda.Builtin.Nat.html#128" class="InductiveConstructor">suc</a> <a id="20095" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Relations.md %}{% raw %}#20041" class="Bound">n</a><a id="20096" class="Symbol">)</a>

<a id="20099" class="Keyword">data</a> <a id="20104" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Relations.md %}{% raw %}#19954" class="Datatype">odd</a> <a id="20108" class="Keyword">where</a>

  <a id="odd.suc"></a><a id="20117" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Relations.md %}{% raw %}#20117" class="InductiveConstructor">suc</a>   <a id="20123" class="Symbol">:</a> <a id="20125" class="Symbol">∀</a> <a id="20127" class="Symbol">{</a><a id="20128" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Relations.md %}{% raw %}#20128" class="Bound">n</a> <a id="20130" class="Symbol">:</a> <a id="20132" href="https://agda.github.io/agda-stdlib/Agda.Builtin.Nat.html#97" class="Datatype">ℕ</a><a id="20133" class="Symbol">}</a>
    <a id="20139" class="Symbol">→</a> <a id="20141" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Relations.md %}{% raw %}#19934" class="Datatype">even</a> <a id="20146" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Relations.md %}{% raw %}#20128" class="Bound">n</a>
      <a id="20154" class="Comment">-----------</a>
    <a id="20170" class="Symbol">→</a> <a id="20172" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Relations.md %}{% raw %}#19954" class="Datatype">odd</a> <a id="20176" class="Symbol">(</a><a id="20177" href="https://agda.github.io/agda-stdlib/Agda.Builtin.Nat.html#128" class="InductiveConstructor">suc</a> <a id="20181" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Relations.md %}{% raw %}#20128" class="Bound">n</a><a id="20182" class="Symbol">)</a>{% endraw %}</pre>
...
<pre class="Agda">{% raw %}<a id="e+e≡e"></a><a id="21360" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Relations.md %}{% raw %}#21360" class="Function">e+e≡e</a> <a id="21366" class="Symbol">:</a> <a id="21368" class="Symbol">∀</a> <a id="21370" class="Symbol">{</a><a id="21371" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Relations.md %}{% raw %}#21371" class="Bound">m</a> <a id="21373" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Relations.md %}{% raw %}#21373" class="Bound">n</a> <a id="21375" class="Symbol">:</a> <a id="21377" href="https://agda.github.io/agda-stdlib/Agda.Builtin.Nat.html#97" class="Datatype">ℕ</a><a id="21378" class="Symbol">}</a>
  <a id="21382" class="Symbol">→</a> <a id="21384" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Relations.md %}{% raw %}#19934" class="Datatype">even</a> <a id="21389" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Relations.md %}{% raw %}#21371" class="Bound">m</a>
  <a id="21393" class="Symbol">→</a> <a id="21395" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Relations.md %}{% raw %}#19934" class="Datatype">even</a> <a id="21400" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Relations.md %}{% raw %}#21373" class="Bound">n</a>
    <a id="21406" class="Comment">------------</a>
  <a id="21421" class="Symbol">→</a> <a id="21423" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Relations.md %}{% raw %}#19934" class="Datatype">even</a> <a id="21428" class="Symbol">(</a><a id="21429" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Relations.md %}{% raw %}#21371" class="Bound">m</a> <a id="21431" href="https://agda.github.io/agda-stdlib/Agda.Builtin.Nat.html#230" class="Primitive Operator">+</a> <a id="21433" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Relations.md %}{% raw %}#21373" class="Bound">n</a><a id="21434" class="Symbol">)</a>

<a id="o+e≡o"></a><a id="21437" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Relations.md %}{% raw %}#21437" class="Function">o+e≡o</a> <a id="21443" class="Symbol">:</a> <a id="21445" class="Symbol">∀</a> <a id="21447" class="Symbol">{</a><a id="21448" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Relations.md %}{% raw %}#21448" class="Bound">m</a> <a id="21450" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Relations.md %}{% raw %}#21450" class="Bound">n</a> <a id="21452" class="Symbol">:</a> <a id="21454" href="https://agda.github.io/agda-stdlib/Agda.Builtin.Nat.html#97" class="Datatype">ℕ</a><a id="21455" class="Symbol">}</a>
  <a id="21459" class="Symbol">→</a> <a id="21461" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Relations.md %}{% raw %}#19954" class="Datatype">odd</a> <a id="21465" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Relations.md %}{% raw %}#21448" class="Bound">m</a>
  <a id="21469" class="Symbol">→</a> <a id="21471" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Relations.md %}{% raw %}#19934" class="Datatype">even</a> <a id="21476" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Relations.md %}{% raw %}#21450" class="Bound">n</a>
    <a id="21482" class="Comment">-----------</a>
  <a id="21496" class="Symbol">→</a> <a id="21498" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Relations.md %}{% raw %}#19954" class="Datatype">odd</a> <a id="21502" class="Symbol">(</a><a id="21503" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Relations.md %}{% raw %}#21448" class="Bound">m</a> <a id="21505" href="https://agda.github.io/agda-stdlib/Agda.Builtin.Nat.html#230" class="Primitive Operator">+</a> <a id="21507" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Relations.md %}{% raw %}#21450" class="Bound">n</a><a id="21508" class="Symbol">)</a>

<a id="21511" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Relations.md %}{% raw %}#21360" class="Function">e+e≡e</a> <a id="21517" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Relations.md %}{% raw %}#19989" class="InductiveConstructor">zero</a>     <a id="21526" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Relations.md %}{% raw %}#21526" class="Bound">en</a>  <a id="21530" class="Symbol">=</a>  <a id="21533" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Relations.md %}{% raw %}#21526" class="Bound">en</a>
<a id="21536" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Relations.md %}{% raw %}#21360" class="Function">e+e≡e</a> <a id="21542" class="Symbol">(</a><a id="21543" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Relations.md %}{% raw %}#20031" class="InductiveConstructor">suc</a> <a id="21547" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Relations.md %}{% raw %}#21547" class="Bound">om</a><a id="21549" class="Symbol">)</a> <a id="21551" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Relations.md %}{% raw %}#21551" class="Bound">en</a>  <a id="21555" class="Symbol">=</a>  <a id="21558" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Relations.md %}{% raw %}#20031" class="InductiveConstructor">suc</a> <a id="21562" class="Symbol">(</a><a id="21563" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Relations.md %}{% raw %}#21437" class="Function">o+e≡o</a> <a id="21569" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Relations.md %}{% raw %}#21547" class="Bound">om</a> <a id="21572" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Relations.md %}{% raw %}#21551" class="Bound">en</a><a id="21574" class="Symbol">)</a>

<a id="21577" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Relations.md %}{% raw %}#21437" class="Function">o+e≡o</a> <a id="21583" class="Symbol">(</a><a id="21584" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Relations.md %}{% raw %}#20117" class="InductiveConstructor">suc</a> <a id="21588" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Relations.md %}{% raw %}#21588" class="Bound">em</a><a id="21590" class="Symbol">)</a> <a id="21592" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Relations.md %}{% raw %}#21592" class="Bound">en</a>  <a id="21596" class="Symbol">=</a>  <a id="21599" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Relations.md %}{% raw %}#20117" class="InductiveConstructor">suc</a> <a id="21603" class="Symbol">(</a><a id="21604" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Relations.md %}{% raw %}#21360" class="Function">e+e≡e</a> <a id="21610" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Relations.md %}{% raw %}#21588" class="Bound">em</a> <a id="21613" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Relations.md %}{% raw %}#21592" class="Bound">en</a><a id="21615" class="Symbol">)</a>{% endraw %}</pre>
...
<pre class="Agda">{% raw %}<a id="24118" class="Keyword">import</a> <a id="24125" href="https://agda.github.io/agda-stdlib/Data.Nat.html" class="Module">Data.Nat</a> <a id="24134" class="Keyword">using</a> <a id="24140" class="Symbol">(</a><a id="24141" href="https://agda.github.io/agda-stdlib/Data.Nat.Base.html#742" class="Datatype Operator">_≤_</a><a id="24144" class="Symbol">;</a> <a id="24146" href="https://agda.github.io/agda-stdlib/Data.Nat.Base.html#765" class="InductiveConstructor">z≤n</a><a id="24149" class="Symbol">;</a> <a id="24151" href="https://agda.github.io/agda-stdlib/Data.Nat.Base.html#807" class="InductiveConstructor">s≤s</a><a id="24154" class="Symbol">)</a>
<a id="24156" class="Keyword">import</a> <a id="24163" href="https://agda.github.io/agda-stdlib/Data.Nat.Properties.html" class="Module">Data.Nat.Properties</a> <a id="24183" class="Keyword">using</a> <a id="24189" class="Symbol">(</a><a id="24190" href="https://agda.github.io/agda-stdlib/Data.Nat.Properties.html#1804" class="Function">≤-refl</a><a id="24196" class="Symbol">;</a> <a id="24198" href="https://agda.github.io/agda-stdlib/Data.Nat.Properties.html#1997" class="Function">≤-trans</a><a id="24205" class="Symbol">;</a> <a id="24207" href="https://agda.github.io/agda-stdlib/Data.Nat.Properties.html#1854" class="Function">≤-antisym</a><a id="24216" class="Symbol">;</a> <a id="24218" href="https://agda.github.io/agda-stdlib/Data.Nat.Properties.html#2109" class="Function">≤-total</a><a id="24225" class="Symbol">;</a>
                                  <a id="24261" href="https://agda.github.io/agda-stdlib/Data.Nat.Properties.html#10952" class="Function">+-monoʳ-≤</a><a id="24270" class="Symbol">;</a> <a id="24272" href="https://agda.github.io/agda-stdlib/Data.Nat.Properties.html#10862" class="Function">+-monoˡ-≤</a><a id="24281" class="Symbol">;</a> <a id="24283" href="https://agda.github.io/agda-stdlib/Data.Nat.Properties.html#10706" class="Function">+-mono-≤</a><a id="24291" class="Symbol">)</a>{% endraw %}</pre>
